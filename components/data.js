...
export const projects = [
  ...
  },
  {
    ...
    description: "A complete social media platform with CRUD operations and image support.",
  ...
  {
    title: "Web Profile",
    description: "Sleek, responsive portfolio website to showcase projects and professional skills with dark mode and tech-tagged project organization.",
    stack: ["Next.js", "Tailwind CSS", "Magic UI"],
    image: "/projects/webprofile.png",
    demoUrl: "https://profile-mu-silk.vercel.app/",
    codeUrl: "https://github.com/Krushan12/profile",
  },
  {
    title: "Kanban Board Task Management",
    description: "Responsive task management system with intuitive drag-and-drop functionality and expandable sidebar and modal interfaces.",
